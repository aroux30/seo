...
const PROVIDER_OPTIONS = [
  { id: "gemini", name: "Google Gemini (پیشنهادی)", defaultModel: "gemini-2.0-flash", color: "from-blue-500 to-indigo-600" },
  ...
  { id: "openrouter", name: "OpenRouter", defaultModel: "google/gemini-2.0-flash-001", color: "from-purple-500 to-pink-600" },
];
